...
b2Body* nc::PhysicsSystem::CreateBody(const Vector2& position,float angle, const RigidBodyData& data, nc::GameObject* gameObject)
{
    b2BodyDef bodyDef;
    ...
    bodyDef.angle = nc::DegreesToRadian(angle);
